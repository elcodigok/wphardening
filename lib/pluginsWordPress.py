    ...
    def __init__(self, directory, proxy):
        ...
        self.list_plugins = [
            ...
            [
                ...
                backup database, restore database, delete backup \
                database, drop/empty tables and run selected queries. \
                Supports automatic scheduling of backing up, optimizing \
                and repairing of database.',
                'http://wordpress.org/extend/plugins/wp-dbmanager/'
            ],
            [
                'User Locker',
                'This plugin locks user account after given number of \
                incorrect login attempts. This makes brute force and \
                dictionary attacks nearly impossible.',
                'http://wordpress.org/extend/plugins/user-locker/'
            ],
            [
                'Limit Login Attempts',
                'Limit rate of login attempts, including by way of \
                cookies, for each IP. Fully customizable.',
                'http://wordpress.org/extend/plugins/limit-login-attempts/'
            ],
            [
                'One-Time Password',
                'One-time password system conform RFC 2289 to protect \
                your weblog in less trustworthy environments, \
                like internet cafes.',
            ...
            [
                ...
                for signs that may indicate that it has fallen victim to \
                malicious hackers.',
